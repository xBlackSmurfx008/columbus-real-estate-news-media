...
const imageUrl = 'https://example.public.blob.vercel-storage.com/cren/article.webp';
const body = [
  answerSummary,
...
function submission() {
  return {
    ...
    claim_ledger: [{ id: 'C1', claim: 'City staff described the filing as an early review step.', source_ids: ['S1'] }],
    entity_ledger: [{ name: 'City of Columbus', source_ids: ['S1'] }],
    image_brief: {
